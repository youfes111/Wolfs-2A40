...
require_once "C:/xampp/htdocs/projet_v5/controler/formationC.php";
require_once "C:/xampp/htdocs/projet_v5/Model/formation.php";
    ...
    <?php $counter = 1; ?>
      ...
      <div class="col-xl-4 col-md-6">
        ...
        <article>
          ...
          <h2 class="title">
            <p class="post-category"><?= $List['langue'] ;?></p>
          </h2>
          <p class="post-category"><h6><?= $List['niveau']  ;?></h6></p>

        
          <div class="post-footer">
           
            <div class="additional-info" style="display: none;">
           <p class="post-category">Prix : <?= $List['prix']  ;?></p>
